...
CASES = [
    ...
    ("T-003", "酒红玫瑰墙 · 自拍姿态", "T-003-rose-selfie.txt", "T2VA",
     "720×1280", 243, "10.125s", "部分成功", "warn",
     "竖屏 T2VA 原创单镜头，零输入图。技术验像通过：243 帧、无黑帧/NaN、无镜头切换。"
     "人物、礼服、玫瑰墙与结尾的手触头发姿态大体稳定；但关键动作未按要求落地：约 7.3 秒退化为对称托脸且双眼闭合，"
     "没有完成指定的单眼 wink。因此作为可观看原型如实收录，未标为验收交付。"),
]
