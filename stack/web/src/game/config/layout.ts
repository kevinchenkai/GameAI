...
export const GAME_UI = {
  ...
  helpButtonHeight: 44,
  /** 弹窗遮罩与面板：深蓝压暗底层，暖白面板浮起 */
  dialogOverlay: 0x34516b,
  dialogPanelFill: 0xfff8e9,
  dialogPanelFillAlpha: 0.98,
  dialogPanelShadowAlpha: 0.14,
  dialogPanelStrokeAlpha: 0.58,
  dialogPanelStrokeWidth: 1.5,
  resultStatFill: 0xffffff,
  resultStatFillAlpha: 0.64,
  resultStatStrokeAlpha: 0.18,
  resultStatLabelColor: '#877b6d',
  resultHintColor: '#7d7569',
  resultWinTitleColor: '#d88b21',
