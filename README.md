...
The repository currently contains three original HTML5 game projects presented through the Codex Games hub: **Wulin Tavern**, **Soulmate**, and **Star Fighter**. Each game represents a different mood and design direction, while sharing the same broader goal: turning small creative ideas into playable AI-assisted game experiences.
